...
func New(repository *storage.Repository) *web.API {
	return &web.API{
		Controllers: []web.Controller{
			user.NewUsersController(repository, web.CredentialsExtractorFunc(web.BasicCredentialsUsernameExtractor)),
			post.NewPostsController(repository, web.CredentialsExtractorFunc(web.BasicCredentialsUsernameExtractor)),
		},
		Filters: []web.Filter{
